    ...
    <el-aside width="192px" class="left">
      ...
      <el-tabs :tab-position="'left'" v-model="activeName" class="tab">
        ...
        <el-tab-pane name="material">
          <div class="item" @click="goMaterial" slot="label"><i class="icon temp"></i> 素材库</div>
        </el-tab-pane>
        <el-tab-pane name="template">
          <div class="item" @click="goTemplate" slot="label"><i class="icon material"></i> 方案库</div>
        </el-tab-pane>
      </el-tabs>
    </el-aside>
