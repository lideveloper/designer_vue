<template>
  <div class="content">
    <el-tabs :tab-position="'top'" v-model="activeName" @tab-click="tabClick">
      <el-tab-pane label="新稿" name="01"></el-tab-pane>
      <el-tab-pane label="过程稿" name="102"></el-tab-pane>
      <el-tab-pane label="确认稿" name="701"></el-tab-pane>
      <el-tab-pane label="已完成" name="a01"></el-tab-pane>
    </el-tabs>
    <div class="body">
      <div class="search-area">
        ...
        <div class="search-button-area">
          ...
          <el-button plain @click="dialogTableVisible = true">弹出</el-button>
        </div>
      </div>
